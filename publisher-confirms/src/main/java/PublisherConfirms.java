/*
 * When publisher confirms are enabled on a channel,
 * messages the client publishes are confirmed asynchronously by the broker,
 * It`s extension to the AMQP 0.9.1 protocol, not enabled by default.
...
public class PublisherConfirms {
    ...
    /* publish a batch of messages and wait for this whole batch to be confirmed */
    ...
    one just needs to register a callback on the client
    to be notified of these confirms: */
